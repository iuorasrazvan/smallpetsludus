...
$addons = array(
    array(
        ...
        'addon_name' => __('WP User Social Login', 'wpuser'),
    ...
    array(
        ...
        'addon_name' => __('WP User Subscription', 'wpuser'),
