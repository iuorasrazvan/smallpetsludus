<header class="main-header">
    <!-- Logo -->
    <a class="logo">
        <span class="logo-mini"><i
                class="menu-icon fa fa-wordpress bg-light-blue"></i><b><?php _e('WP User', 'upuser') ?></b></span>
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- Task item -->
                                    <a target="_blank" href="http://www.wpseeds.com/product/wp-all-backup/">WP ALL
                                        Backup
                                        <h3>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><i
                                class="menu-icon fa  fa-user bg-light-blue"></i> <?php _e('WPSeeds', 'upuser') ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <a target="_blank" href="http://wpseeds.com"><img
