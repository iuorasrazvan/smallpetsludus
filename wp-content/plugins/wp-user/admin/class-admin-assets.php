    ...
    class WPUserAdminAssets
    {
        ...
        public function admin_scripts()
        {
            if (isset($_GET['page'])) {
                ...
                if (in_array($_GET['page'], array("wp-user-setting", "wp-user-list", 'wp-user-subscription','wp-user-addons'))) {
                    ...
                    if ($wp_user_cdn_enable == '1') {
                        ...
                        wp_enqueue_style('wpdbadminltecss', WPUSER_PLUGIN_URL . "assets/dist/css/AdminLTE.css");//Custom CSS
                        ...
                        if (in_array($_GET['page'], array('wp-user-setting', 'wp-user-subscription','wp-user-addons'))) {
                            wp_enqueue_script('wpdbapp', WPUSER_PLUGIN_URL . "assets/dist/js/app.min.js");
