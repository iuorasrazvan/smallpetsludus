...
$layout_settings_form_design_background_color_contact_bank = isset($layout_settings_form_design_background_color) != "" ? user_helper_contact_bank::hex2rgb_contact_bank($layout_settings_form_design_background_color) : array("", "", "");
...
$layout_settings_error_messages_background_color_contact_bank = isset($layout_settings_error_messages_background_color) != "" ? user_helper_contact_bank::hex2rgb_contact_bank($layout_settings_error_messages_background_color) : array("", "", "");
...
//Language Direction 
$language_direction_contact_bank = isset($selected_general_setting_unserialize["language_direction"]) && $selected_general_setting_unserialize["language_direction"] == "right_to_left" ? "rtl" : "ltr";
?>
<style type="text/css">
<?php
echo isset($import_font_family_form_layout) ? htmlspecialchars_decode($import_font_family_form_layout) : "";
?>
   .language_direction_contact_bank_<?php echo $random; ?>
   {
      direction:<?php echo $language_direction_contact_bank; ?> !important;
   }
   label.custom-error
   {
<?php
...
/*      display: inline-block;*/
      font-size: <?php echo $layout_settings_error_messages_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_error_messages_font_style[1]; ?> !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[6] ?>
   }
   .cb-limit-input
   {
<?php
...
?>
   ...
   .divider-line-seperator_<?php echo $random; ?>
   {
      height: 1px;
      background: #717171;
   ...
   .main_container_contact_bank_<?php echo $random; ?>
   {
<?php
switch ($layout_settings_form_design_position) {
   ...
   default:
      ?>
            float: <?php echo $layout_settings_form_design_position; ?> !important;
      <?php
      break;
}
?>
      width: <?php echo $layout_settings_form_design_width; ?> !important;
      clear: both;
   }
   .form-layout-main-container-contact-bank_<?php echo $random; ?>
   {
<?php
...
?>
   ...
   .form-layout-title-contact-bank_<?php echo $random; ?> <?php echo $layout_settings_form_design_title_html_tag; ?>
   {
      text-align: <?php echo $layout_settings_form_design_title_alignment; ?> !important;
      font-size: <?php echo $layout_settings_form_design_title_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_form_design_title_font_style[1]; ?> !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[0] ?>
   }
   .form-layout-description-contact-bank_<?php echo $random; ?> <?php echo $layout_settings_form_design_description_html_tag; ?>
   {
      text-align: <?php echo $layout_settings_form_design_description_alignment; ?> !important;
      font-size: <?php echo $layout_settings_form_design_description_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_form_design_description_font_style[1]; ?> !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[1] ?>
   }
<?php
if ($layout_settings_input_field_radio_button_alignment == "single_row") {
   ?>
      .input_radio_button_label_contact_bank_<?php echo $random; ?>
      {
         font-size: <?php echo $layout_settings_label_field_font_style[0]; ?>px !important;
         display:inline-block !important;
         margin-left: 8px !important;
         font-family: <?php echo $font_family_form_name_layout[2] ?>
      }
      .input_radio_button_contact_bank_<?php echo $random; ?>
      {
...
if ($layout_settings_input_field_checkbox_alignment == "single_row") {
   ?>
      .input_chk_button_label_contact_bank_<?php echo $random; ?>
      {
         font-size: <?php echo $layout_settings_label_field_font_style[0]; ?>px !important;
         font-family: <?php echo $font_family_form_name_layout[2] ?>;
         display:inline-block !important;
      ...
      .input_chk_button_contact_bank_<?php echo $random; ?>
      {
/*         margin-left: 9px !important;*/
      }
   <?php
...
?>
   .right-placement-input-contact-bank_<?php echo $random; ?>::-webkit-input-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .right-placement-input-contact-bank_<?php echo $random; ?>::-moz-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .right-placement-input-contact-bank_<?php echo $random; ?>
   {
      width: 60% !important;
      float: left !important;
      height: <?php echo $layout_settings_input_field_height; ?> !important;
      text-align: <?php echo $layout_settings_input_field_text_alignment; ?> !important;
      font-size: <?php echo $layout_settings_input_field_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_input_field_font_style[1]; ?> !important;
      ...
      border-radius: <?php echo $layout_settings_input_field_border_radius ?>px !important;
      -webkit-border-radius: <?php echo $layout_settings_input_field_border_radius ?>px !important;
      -moz-border-radius: <?php echo $layout_settings_input_field_border_radius ?>px !important;
   ...
   .right-placement-input-contact-bank_credit_card_<?php echo $random; ?>::-webkit-input-placeholder{
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .right-placement-input-contact-bank_credit_card_<?php echo $random; ?>::-moz-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .right-placement-input-contact-bank_credit_card_<?php echo $random; ?>
   {
      width: 60% !important;
      height: <?php echo $layout_settings_input_field_height; ?> !important;
      text-align: <?php echo $layout_settings_input_field_text_alignment; ?> !important;
   ...
   .left-placement-input-contact-bank_<?php echo $random; ?>::-webkit-input-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .left-placement-input-contact-bank_<?php echo $random; ?>::-moz-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .left-placement-input-contact-bank_<?php echo $random; ?>
   {
      width: 60% !important;
<?php
...
?>
   ...
   .left-placement-input-contact-bank_credit_card_<?php echo $random; ?>::-webkit-input-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .left-placement-input-contact-bank_credit_card_<?php echo $random; ?>::-moz-placeholder{
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .left-placement-input-contact-bank_credit_card_<?php echo $random; ?>
   {
      width: 60% !important;
<?php
if ($layout_settings_input_field_background_color_transparency[0] != "") {
...
?>
   ...
   .input-layout-field-contact-bank_<?php echo $random; ?>
   {
<?php
if ($layout_settings_input_field_background_color_transparency[0] != "") {
   ?>
...
?>
      ...
      margin: <?php echo intval($layout_settings_input_field_margin[0]); ?>px <?php echo intval($layout_settings_input_field_margin[1]); ?>px <?php echo intval($layout_settings_input_field_margin[2]); ?>px <?php echo intval($layout_settings_input_field_margin[3]); ?>px !important;
      padding: <?php echo intval($layout_settings_input_field_padding[0]); ?>px <?php echo intval($layout_settings_input_field_padding[1]); ?>px <?php echo intval($layout_settings_input_field_padding[2]); ?>px <?php echo intval($layout_settings_input_field_padding[3]); ?>px !important;
      width: <?php echo $layout_settings_input_field_width; ?> !important;
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .input-layout-field-contact-bank_<?php echo $random; ?>::-webkit-input-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .input-layout-field-contact-bank_<?php echo $random; ?>::-moz-placeholder {
      font-family: <?php echo $font_family_form_name_layout[2] ?>;
   }
   .label_left_placement_<?php echo $random; ?>
   {
      position: relative;
      display: inline-block;
      bottom: 2px;
      width: 30% !important;
      float: left !important;
      text-align: <?php echo $layout_settings_label_field_text_alignment; ?> !important;
      height: <?php echo $layout_settings_label_field_height; ?> !important;
      font-size: <?php echo $layout_settings_label_field_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_label_field_font_style[1]; ?> !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[3] ?>
   }
   .radio_list_label_right_placement_<?php echo $random; ?>
   {
      float: left;
      width: 60%;
      display: inline-block;
   ...
   .radio_list_label_<?php echo $random; ?>
   {
   ...
   .checkbox_label_right_placement_<?php echo $random; ?>
   {
      float: right;
      width: 60%;
      bottom: 10px;
   ...
   .checkbox_input_right_placement_<?php echo $random; ?>
   {
      display: inline-block;
      position: relative;
      width: 30%;
   }
   .label_left_placement_credit_card_<?php echo $random; ?>
   {
      width: 30% !important;
      display: inline-block;
      vertical-align: middle;
   ...
   .label-layout-field-contact-bank_<?php echo $random; ?>
   {
<?php
...
?>
      text-align: <?php echo $layout_settings_label_field_text_alignment; ?> !important;
      width: <?php echo $layout_settings_label_field_width; ?> !important;
      height: <?php echo $layout_settings_label_field_height; ?> !important;
      font-size: <?php echo $layout_settings_label_field_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_label_field_font_style[1]; ?> !important;
      margin: <?php echo intval($layout_settings_label_field_margin[0]); ?>px <?php echo intval($layout_settings_label_field_margin[1]); ?>px <?php echo intval($layout_settings_label_field_margin[2]); ?>px <?php echo intval($layout_settings_label_field_margin[3]); ?>px !important;
   ...
   .button-layout-contact-bank_<?php echo $random; ?>
   {
<?php
...
?>
      text-align: <?php echo $layout_settings_button_text_alignment; ?> !important;
      width: <?php echo $layout_settings_button_width; ?> !important;
      height: <?php echo $layout_settings_button_height; ?> !important;
      font-size: <?php echo $layout_settings_button_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_button_font_style[1]; ?> !important;
      ...
      border-radius: <?php echo $layout_settings_button_border_radius ?>px !important;
      -webkit-border-radius: <?php echo $layout_settings_button_border_radius ?>px !important;
      -moz-border-radius: <?php echo $layout_settings_button_border_radius ?>px !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[4] ?>;
      display: inline-block !important;
      text-transform: none !important;
   }
   .button-layout-contact-bank_<?php echo $random; ?>:hover
   {
<?php
if ($layout_settings_button_hover_background_color != "") {
   ?>
         ...
         border-color: <?php echo $layout_settings_button_border_hover_color; ?> !important;
   <?php
}
?>
   }
   .file-upload-button-style-contact-bank_<?php echo $random; ?>
   {
<?php
if ($layout_settings_button_background_color != "") {
   ?>
...
?>
   ...
   .file-upload-button-style-contact-bank_<?php echo $random; ?>:hover
   {
<?php
if ($layout_settings_button_hover_background_color != "") {
   ?>
...
?>
   ...
   .message-layout-contact-bank_<?php echo $random; ?>
   {
      text-align: <?php echo $layout_settings_messages_text_alignment; ?> !important;
      direction: inherit !important;
      background: url(<?php echo plugins_url("assets/img/icon-succes.png", dirname(__FILE__)); ?>) no-repeat 8px 3px <?php if ($layout_settings_messages_background_color_transparency[0] != "")  ?> rgba(<?php echo intval($layout_settings_messages_background_color[0]); ?>,<?php echo intval($layout_settings_messages_background_color[1]); ?>,<?php echo intval($layout_settings_messages_background_color[2]); ?>,<?php echo floatval($layout_settings_messages_background_transparency); ?>) !important;
   }
   .custom-message
   {
      position: relative;
   ...
   #success_message_text_<?php echo $random; ?>
   {
      font-size: <?php echo $layout_settings_messages_font_style[0]; ?>px !important;
      color: <?php echo $layout_settings_messages_font_style[1]; ?> !important;
      ...
      font-family: <?php echo $font_family_form_name_layout[5] ?>
   }
   .error-message
   {
      text-align: <?php echo $layout_settings_messages_text_alignment; ?> !important;
      background: url(<?php echo plugins_url("assets/img/no.png", dirname(__FILE__)); ?>) no-repeat 8px 6px #FFBABA !important;
   }
   .error_message_text
   {
      font-size: <?php echo $layout_settings_messages_font_style[0]; ?>px !important;
