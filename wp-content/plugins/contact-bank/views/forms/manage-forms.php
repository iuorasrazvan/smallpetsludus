                     ...
                     <div class="form-body">
                        <div class="table-top-margin">
                           <select name="ux_ddl_bulk_action" id="ux_ddl_bulk_action">
                              ...
                              <option value="delete" style="color:red;"><?php echo $cb_bulk_delete . " (" . $cb_premium_edition . " )"; ?></option>
                              <option value="duplicate" style="color:red;"><?php echo $cb_bulk_duplicate . " (" . $cb_premium_edition . " )"; ?></option>
                           </select>
                           ...
                           <a href="javascript:;" onclick="add_new_form_contact_bank();" class="btn vivid-green"><?php echo $cb_add_form; ?></a>
                        </div>
                           ...
                           <tbody>
                              ...
                              foreach ($unserialized_forms_data_array as $row) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php echo isset($row["form_title"]) && $row["form_title"] != "" ? "<p>" . esc_attr($row["form_title"]) . " - " . "(" . "<strong>" . $form_id . "</strong>" . ")" . "</p>" : "<p>" . $cb_untitled_form . " - " . "(" . "<strong>" . $form_id . "</strong>" . ")" . "</p>"; ?>
                                       <?php echo isset($row["form_description"]) && $row["form_description"] != "" ? "<p>" . htmlspecialchars_decode($row["form_description"]) . "</p>" : "<p></p>"; ?>
                                       <strong><?php echo "Shortcode"; ?> :</strong>
                                       <div class="icon-custom-docs tooltips pull-right" style="font-size:18px;" data-original-title="<?php echo $cb_shortcode_copy_to_clipboard; ?>" data-placement="left" data-clipboard-action="copy" data-clipboard-target="#ux_txtarea_generate_shortcodes_<?php echo intval($row["old_form_id"]) ?>"></div>
                                    ...
                                    <td class="custom-alternative">
                                       <a href="admin.php?page=cb_add_new_form&form_id=<?php echo $row["old_form_id"]; ?>&mode=edit" class="button-contact-bank" style="width:146px;">
                                          <i class="icon-custom-pencil manage-form-icon-contact-bank"></i>
                                          <?php echo $cb_edit; ?>
                                       </a>
                                       <a href="javascript:void(0);" class="button-contact-bank" style="width:146px;" onclick="confirm_delete_contact_bank('<?php echo $row["meta_id"]; ?>', '<?php echo $cb_form_delete_single_message; ?>', 'contact_dashboard', 'delete_contact_forms');" data-placement="right">
                                       ...
                                       <a href="javascript:void(0);" class="button-contact-bank" style="width:146px;" onclick="premium_edition_notification_contact_bank();" data-placement="right">
                                          ...
                                          <?php echo $cb_duplicate; ?>
                                       </a>
                                       <a href="admin.php?page=cb_email_templates&form_id=<?php echo $row["meta_id"]; ?>" class="button-contact-bank" style="width:146px;">
                                          <i class="icon-custom-envelope manage-form-icon-contact-bank"></i>
                                          <?php echo $cb_email_settings; ?>
                                       </a>
                                       <a href="admin.php?page=cb_submissions&form_id=<?php echo $row["old_form_id"]; ?>" class="button-contact-bank" style="width:146px;">
                                          <i class="icon-custom-grid manage-form-icon-contact-bank"></i>
                                          <?php echo $cb_form_entries; ?>
                                       </a>
                                    </td>
                                 </tr>
                                 <?php
