   ...
   if (!$access_granted) {
      ...
      <div id="contact-bank" style="display:none;">
         <div class="fluid-layout responsive">
            <div style="padding:20px 0 10px 15px;">
               <h3 class="label-shortcode"><?php echo $cb_shortcode_button_insert_form; ?></h3>
               <span>
                  <i><?php echo $cb_shortcode_button_add; ?></i>
               </span>
            </div>
            <div class="layout-span12 responsive" style="padding:15px 15px 0 0;">
               <div class="layout-control-group">
                  <label class="custom-layout-label" for="ux_form_name"><?php echo $cb_shortcode_form_name; ?> : </label>
                  <select id="add_contact_form_id" class="layout-span9">
                     <option value=""><?php echo $cb_shortcode_button_select_form; ?>  </option>
                     <?php
                     global $wpdb;
                     ...
                     foreach ($unserialized_forms_data_array as $data) {
                        ?>
                        <option value="<?php echo $data["old_form_id"]; ?>"><?php echo $data["form_title"] != "" ? $data["form_title"] : "Untitled Form"; ?></option>
                        <?php
                     }
                     ?>
                  </select>
               ...
               <div class="layout-control-group" style="padding:20px 0 0 0;">
                  <label class="custom-layout-label"><?php echo $cb_shortcode_show_form_title; ?> : </label>
                  ...
                  <label class="custom-layout-label description-contact-bank"><?php echo $cb_shortcode_show_form_description; ?> :</label>
               ...
               <div class="layout-control-group" style="padding:25px 0 0 0;">
                  ...
                  <input type="button" class="button-primary" value="<?php echo $cb_shortcode_insert_form; ?>" onclick="generate_shortcode_contact_bank();"/>&nbsp;&nbsp;&nbsp;
                  <a class="button" style="color:#bbb;" href="#" onclick="tb_remove(); return false;"><?php echo $cb_shortcode_cancel; ?></a>
               </div>
            </div>
         </div>
      </div>
      <script type="text/javascript">
         function generate_shortcode_contact_bank()
         {
            ...
            if (form_id === "")
            {
               alert("<?php echo $cb_shotcode_button_choose_form ?>");
               return;
            }
